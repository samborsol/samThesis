...
\begin{figure}%
    \centering
    \subfloat[label 1]{{\includegraphics[width=6cm]{Chapter1/importfigs/star_130_fig3.png} }}%
    \qquad
    \subfloat[label 2]{{\includegraphics[width=6cm]{Chapter1/importfigs/star_130_fig4.png} }}%
...
\begin{figure}%
    \centering
    \subfloat[label 1]{{\includegraphics[width=6cm]{Chapter1/importfigs/corr2D_pPbNew_pt0-0_nmin220_nmax260_20130206.png} }}%
    \qquad
    \subfloat[label 2]{{\includegraphics[width=6cm]{Chapter1/importfigs/corr2D_PbPb_pt0-0_nmin220_nmax260_20130325.png} }}%
...
\begin{figure}[htp]
  ...
  \subfloat[Subcaption 1]{\label{figur:1}\includegraphics[width=90mm]{Chapter1/importfigs/chakraburti_1.png}}
  \subfloat[Subcaption 2]{\label{figur:2}\includegraphics[width=90mm]{Chapter1/importfigs/chakraburti_2.png}}
  \\
  \subfloat[Subcaption 3]{\label{figur:3}\includegraphics[width=90mm]{Chapter1/importfigs/chakraburti_3.png}}
  \subfloat[Subcaption 4]{\label{figur:4}\includegraphics[width=90mm]{Chapter1/importfigs/chakraburti_4.png}}
  \\
  \subfloat[Subcaption 5]{\label{figur:5}\includegraphics[width=90mm]{Chapter1/importfigs/chakraburti_5.png}}
  \subfloat[Subcaption 6]{\label{figur:6}\includegraphics[width=90mm]{Chapter1/importfigs/chakraburti_6.png}}
