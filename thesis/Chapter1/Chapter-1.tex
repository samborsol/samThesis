...
[something about pQCD and NLO-pQCD] \cite{CGC2Lec}\cite{CGCandGlasma}.
...
[\cite{Hatta:2016dxp} \cite{Boer:2011fh} ] Figure \ref{fig:nuclImag} shows an illustration of how the nucleus appears at varying momentum fractions.
...
\begin{figure}%
    \centering
    \subfloat[]{{\includegraphics[width=6cm]{Chapter1/importfigs/star_130_fig3.png} }}%
    \qquad
    \subfloat[]{{\includegraphics[width=6cm]{Chapter1/importfigs/star_130_fig4.png} }}%
