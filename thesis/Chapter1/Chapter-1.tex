...
The Super Proton Synchrotron operated as a proton-proton collision experiment between 1981 and 1991 \cite{spsHI}.

The Relativistic Heavy Ion Collider (RHIC) performed the first experiments for the existence of QGP \cite{ags2rhic}\cite{etaOvSinit}.

The Large Hadron Collider (LHC) stands at the forefront of high energy nuclear physics research \cite{Roland:2014jsa}\cite{Frankfurt:2005mc}\cite{Vogt:2002ve}.
