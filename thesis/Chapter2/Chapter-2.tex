...
\begin{figure}%
    \centering
    \subfloat[label 1]{{\includegraphics[width=7.cm]{Chapter2/importfigs/patkenny_Figure_001-a.png} }}%
    \qquad
    \subfloat[label 2]{{\includegraphics[width=7.cm]{Chapter2/importfigs/patkenny_Figure_001-b.png} }}%
...
\par\end{centering}
\caption{H1, Diffractive Dijets, Kinematics \cite{Aaron:2010aa} \label{fig:h1Kinematics}}
\end{figure}
